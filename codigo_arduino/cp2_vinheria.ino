...
#define DHTPIN A2                          // Pino do Arduino conectado no Sensor(Data) 
...
//************************
int ledVermelhoPin = 8;   // LED vermelho no pino 9
int ledAmareloPin = 6;   // LED amarelo no pino 10
int ledVerdePin = 7;   // LED verde no pino 11
int ldrPin = A1;  // LDR no pino A1
int buzzerPin = 13;   // Buzzer no pino 7
int sensorTempPin = A2;  // Sensor de temperatura no pino A2
int sensorUmidPin = A3;  // Sensor de umidade no pino A0 
